...
def load_config():
    ...
    parser.add_argument('--data_name', default="hcp", type=str, help="name of the dataset:[5T]")
    parser.add_argument('--train_type', default="surf", type=str, help="type of training: [seg, surf]")
    parser.add_argument('--surf_type', default="wm", type=str, help="type of the surface: [wm, gm, outer]")
    ...
    parser.add_argument('--datasplit_csv', default="./data/subject_split.csv", type=str, help="path for data split csv")
    parser.add_argument('--pretrained_path', default=None, type=str, help="path for pretrained model")

    parser.add_argument('--batch_size', default=1, type=str, help="batch_size for pretrain or eval model")
